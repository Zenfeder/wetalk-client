            ...
            <div class="row">
                <div class="col-md-12">
                    <template v-if="posts.length<=0">
                        <h3 class="text-center text-gray" v-if="profile.followingNum==0">你还没关注任何人呢</h3>
                        <h3 class="text-center text-gray" v-if="profile.followingNum>0">这里跟杭州的冬天一样冷清</h3>
                        <div class="text-center text-gray"><small>( 这里会显示你关注的人和你的最新动态 )</small></div>
                    </template>
                            ...
                            <div class="post" v-for="post in posts">
                                <div class="user-block">
                                    ...
                                    <span class="description">
                                        发布于-<small>{{post.created_at | formatDate}}</small>
                                    </span>
                                </div>
                                <!-- /.user-block -->
