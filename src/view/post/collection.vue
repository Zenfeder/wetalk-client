        ...
        <section class="content clearfix">
            <div class="row">
                <template v-if="posts.length<=0">
                    <div class="col-md-12">
                        <h3 class="text-center text-gray">你的收藏夹像我钱包一样空</h3>
                    </div>
                </template>

                <template v-if="posts.length>0">
                    <div class="col-md-12"  v-for="(post, postIndex) in posts">
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        ...
                                        <span class="username">
                                            ...
                                            <a href="javascript:void(0);" class="pull-right btn-box-tool" data-toggle="tooltip" data-placement="left" data-original-title="移出收藏夹" @click="discollect(post, postIndex)"><i class="fa fa-trash text-gray"></i></a>
                                        </span>
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="link-black text-sm" @click="discollect(post, postIndex)">
...
export default {
    ...
    methods: {
        ...
        discollect (post, postIndex) {
            const _self = this;

            var layerConfirm = layer.confirm("是否移出收藏夹？", {
                btn: ['是', '否'],
                title: false,
                closeBtn: 0,
                shadeClose: true
